...
var socksSource = socksController.routeServer("tcp", 0, "tcp", tcpOutSource, "forward", "localhost:10000").get();
...
var socksRemoteSource = socksController.routeServer("tcp", 0, "tcp", tcpRemoteOutSource, "forward", "10.0.2.15:10000").get();
